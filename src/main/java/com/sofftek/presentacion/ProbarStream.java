...
import com.sofftek.modelo.Cliente;
...
//        appStream.m2Descendente(list);
//        appStream.m3Adulto(list);
//        appStream.m4MayorAdulto(list);
//        appStream.m5MaxMinSalario(list);
//        appStream.m6Promedio(list);
//        appStream.m7Resumen(list);
//        appStream.m8Distinto(list);
//        appStream.m9Contar(list);
//        appStream.m10skipLimit(list);
//        appStream.m11getAnyYounger(list);
//        appStream.m12flatMap(list);
//        appStream.m12map(list);
//        appStream.m14peek(list);
//        appStream.m15GroupBy(list);
//        appStream.m16ToMapToSet(list);
